...
function Template10CACTI(props) {
  ...
  const questions = [
    ...
    {
      type: "input",
      question: "Enter the full name of the company",
    ...
    {
      type: "input",
      question: "Enter the address of the company",
            ...
            <div className="flex justify-between gap-20">
              ...
              <div className="w-3/5 py-3 shadow-md border">
                ...
                >
                  ...
                  >
                    <font ref={consultantAddressOfCommunicationRef}>
                      {insertInput(
                        consultantAddressOfCommunication,
                        "underline bold"
                      )}
                  ...
                  >
                    <font ref={clientAddressOfCommunicationRef}>
                      {insertInput(
                        clientAddressOfCommunication,
                        "underline bold"
                      )}
                    </font>
                    <font face="Garamond, serif">
...
export default Template10CACTI;
