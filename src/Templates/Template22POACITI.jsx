...
function Template22POACITI(props) {
  ...
  const questions = [
    ...
    {
      type: "input",
      question: "Enter the full name of individual (donor)",
    ...
    {
      type: "input",
      question: "Enter the full address of individual (donor)",
    ...
    {
      type: "input",
      question: "Enter the full name of the other individual (donee)",
    ...
    {
      type: "input",
      question: "Enter the full address of the other individual (donee)",
                  ...
                  <div>
                    ...
                    <div className="">
                      <p
                        ...
                        style={{ lineHeight: "108%", marginBottom: "0.11in" }}
                      >
                        By the within named <b>DONOR</b>
                      </p>
                      <p>------------------------</p>
                      <p>{insertInput(nameOfDonor)}</p>
                    </div>
                    <p
                      align="justify"
                      style={{ lineHeight: "108%", marginBottom: "0.11in" }}
