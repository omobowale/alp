...
function Template27POASPITC(props) {
  //question index
  ...
  const questions = [
    ...
    {
      type: "input",
      question: "Enter the full name of the company (donee)",
    ...
    {
      type: "input",
      question: "Enter the full address of the company (donee)",
...
export default Template27POASPITC;
