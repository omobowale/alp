          ...
          <div className="template-container py-2 px-4" style={{ height: "70vh", overflow: "scroll" }}>
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  The following terms and conditions (“Terms”) govern all use of the
                  {insertInput(collectiveNameOfApp)} website and the {insertInput(nameOfApp)} app, and all content,
                  services, and products available at or through the website and/or
                  the app. Our Services are offered subject to your acceptance without
                  ...
                  {insertInput(collectiveNameOfApp)} ’s Privacy Policy) and procedures that may be published
                  from time to time by {insertInput(collectiveNameOfApp)} (collectively, the “Agreement”). You
                  agree that we may automatically upgrade our Services, and these
                  Terms will apply to any upgrades.
                </font>
              </font>
            </p>
            <p
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  ...
                  {insertInput(collectiveNameOfApp)}, acceptance is expressly limited to these Terms.
                </font>
              </font>
            </p>
            <p
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  Our Services are not directed to children younger than 18, and
                  access and use of our Services is only offered to users 18 years of
                  age or older. If you are under 18 years old, please do not register
                  to use our Services. Any person who registers as a user or provides
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  Use of our Services requires a {insertInput(collectiveNameOfApp)} account. You agree to
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  By selecting an in-app payment, you agree to pay {insertInput(collectiveNameOfApp)} the
                  monthly or annual subscription fees indicated for that service.
                  Payments will be charged on a pre-pay basis on the day you sign up
                  and will cover the use of that service for a monthly or annual
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  Unless you notify {insertInput(collectiveNameOfApp)} before the end of the applicable
                  subscription period that you want to cancel your subscription, the
                  subscription will automatically renew and you authorize us to
                  collect the then-applicable annual or monthly subscription fee for
                  such subscription (as well as any taxes) using any credit card or
                  other payment mechanism we have on record for you. Subscriptions can
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  {insertInput(collectiveNameOfApp)} goes to great lengths to review all of the material on
                  our website and in our app, and we make every effort to ensure that
                  our information is always up-to-date and accurate. However, this
                  information is subject to change and we cannot be responsible for
                  any discrepancies or inaccuracies. By operating our Services,
                  {insertInput(collectiveNameOfApp)} does not represent or imply that it endorses the material
                  there posted, or that it believes such material to be accurate,
                  useful, or non-harmful. You are responsible for taking precautions
                  ...
                  content. {insertInput(collectiveNameOfApp)} disclaims any responsibility for any harm
                  resulting from the use by visitors of our Services, or from any
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  ...
                  webpages to which {insertInput(collectiveNameOfApp)} links, and that link to {insertInput(collectiveNameOfApp)}.
                  {insertInput(collectiveNameOfApp)} does not have any control over those non- {insertInput(collectiveNameOfApp)}
                  websites, and is not responsible for their contents or their use. By
                  linking to a non- {insertInput(collectiveNameOfApp)} website, {insertInput(collectiveNameOfApp)} does not represent
                  ...
                  harmful or destructive content. {insertInput(collectiveNameOfApp)} disclaims any
                  responsibility for any harm resulting from your use of non-
                  {insertInput(collectiveNameOfApp)} websites and webpages.
                </font>
              </font>
            </p>
            <p
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  If you use any Third Party Services which you may have found
                  information about or contacted via {insertInput(collectiveNameOfApp)}, you understand that:
                </font>
              </font>
            </p>
            <p
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  ...
                  (“Third Party”) and will be governed by the Third Party’s terms and
                  policies. It is your responsibility to review the Third Party’s
                  terms and policies before using a Third Party Service.
                </font>
              </font>
            </p>
            <p
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  ...
                  (yours, your visitors’, or customers’) data. If you grant access,
                  your data will handled in accordance with the Third Party’s privacy
                  policy and practices. We do not have control over how a Third Party
                  Service may use your data. You should carefully review Third Party
                  Services’ data collection, retention, and use policies and practices
                  before enabling Third Party Services.
                </font>
              </font>
            </p>
            <p
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  As {insertInput(collectiveNameOfApp)} asks others to respect its intellectual property
                  rights, it respects the intellectual property rights of others. If
                  you believe that material located on or linked to by {insertInput(collectiveNameOfApp)}
                  violates your copyright, you are encouraged to notify {insertInput(collectiveNameOfApp)}
                  immediately. {insertInput(collectiveNameOfApp)} will respond to all such notices, including
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  This Agreement does not transfer from {insertInput(collectiveNameOfApp)} to you any
                  {insertInput(collectiveNameOfApp)} or third party intellectual property, and all right,
                  title, and interest in and to such property will remain (as between
                  the parties) solely with {insertInput(collectiveNameOfApp)} . {insertInput(collectiveNameOfApp)}, the {insertInput(collectiveNameOfApp)}
                  logo, and all other trademarks, service marks, graphics and logos
                  used in connection with {insertInput(collectiveNameOfApp)} or our Services, are trademarks
                  or registered trademarks of {insertInput(collectiveNameOfApp)} or {insertInput(collectiveNameOfApp)}’s licensors.
                  ...
                  reproduce or otherwise use any {insertInput(collectiveNameOfApp)} or third-party trademarks.
                </font>
              </font>
            </p>
            <p
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  ...
                  posting on one of our blogs, or by sending you an email or other
                  communication before the changes take effect. The notice will
                  ...
                  using our Services within the designated notice period. Your
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  {insertInput(collectiveNameOfApp)} may terminate your access to all or any part of our
                  ...
                  your {insertInput(collectiveNameOfApp)} account (if you have one), you may simply
                  discontinue using our Services. All provisions of this Agreement
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  Our Services are provided “as is.” {insertInput(collectiveNameOfApp)} and its suppliers and
                  licensors hereby disclaim all warranties of any kind, express or
                  implied, including, without limitation, the warranties of
                  merchantability, fitness for a particular purpose and
                  non-infringement. Neither {insertInput(collectiveNameOfApp)} nor its suppliers and
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  Except to the extent that applicable law, if any, provides
                  otherwise, this Agreement and any access to or use of our Services
                  will be governed by and construed in accordance with the laws of
                  Nigeria without regard to the principles of conflicts of law.
                </font>
              </font>
            </p>
            <p
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  In no event will {insertInput(collectiveNameOfApp)} , or its suppliers or licensors, be
                  ...
                  {insertInput(collectiveNameOfApp)} under this Agreement during the twelve (12) month period
                  prior to the cause of action. {insertInput(collectiveNameOfApp)} shall have no liability for
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  You represent and warrant that (i) your use of our Services will be
                  in strict accordance with the {insertInput(collectiveNameOfApp)} Privacy Policy, with this
                  ...
                  the transmission of technical data exported from the United Kingdom
                  or the country in which you reside) and (ii) your use of our
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  You agree to indemnify and hold harmless {insertInput(collectiveNameOfApp)} , its
                  ...
                  our Services, including but not limited to your violation of this
                  Agreement.
                </font>
              </font>
            </p>
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  This Agreement constitutes the entire agreement between {insertInput(collectiveNameOfApp)}
                  ...
                  {insertInput(collectiveNameOfApp)}, or by the posting by {insertInput(collectiveNameOfApp)} of a revised version.
                </font>
              </font>
            </p>
            <p
            ...
            >
              <font face='Garamond, serif'>
                ...
                >
                  ...
                  {insertInput(collectiveNameOfApp)} may assign its rights under this Agreement without
