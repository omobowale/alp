...
function Template3AAITC(props) {
  ...
  const [nameOfCompany, setNameOfCompany] = useState(
    getCurrentValue("nameOfCompany")
  );
  const [addressOfCompany, setAddressOfCompany] = useState(
    getCurrentValue("addressOfCompany")
  );
  ...
  const questions = [
    ...
    {
      type: "input",
      question: "Enter the full name of the individual",
    ...
    {
      type: "input",
      question: "Enter the full address of individual",
    ...
    },
    {
      ...
      key: "nameOfCompany",
      response: nameOfCompany,
      ref: nameOfCompanyRef,
    },
    {
      type: "input",
      question: "Enter the full address of company",
      action: setAddressOfCompany,
      key: "addressOfCompany",
      response: addressOfCompany,
      ref: addressOfCompanyRef,
    },
                ...
                >
                  <div>
                    ...
                    >
                      <font face="Garamond, serif">
                        <font size={3} style={{ fontSize: "12pt" }}>
                          <b>SIGNED FOR AND ON BEHALF OF THE AGENT </b>
                        </font>
                      </font>
                    </p>
                    <p
