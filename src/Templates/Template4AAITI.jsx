...
function Template4AAITI(props) {
  ...
  const nameOfIndividualRef = useRef();
  const addressOfIndividualRef = useRef();
  const nameOfIndividual2Ref = useRef();
  const addressOfIndividual2Ref = useRef();
  ...
  const [nameOfIndividual, setNameOfIndividual] = useState(
    getCurrentValue("nameOfIndividual")
  );
  const [addressOfIndividual, setAddressOfIndividual] = useState(
    getCurrentValue("addressOfIndividual")
  );
  const [nameOfIndividual2, setNameOfIndividual2] = useState(
    getCurrentValue("nameOfIndividual2")
  );
  const [addressOfIndividual2, setAddressOfIndividual2] = useState(
    getCurrentValue("addressOfIndividual2")
  );
  ...
  const questions = [
    ...
    {
      type: "input",
      question: "Enter the full name of the first individual (Principal)",
      action: setNameOfIndividual,
      key: "nameOfIndividual",
      response: nameOfIndividual,
      ref: nameOfIndividualRef,
    },
    {
      type: "input",
      question: "Enter the full address of first individual (Principal)",
      action: setAddressOfIndividual,
      key: "addressOfIndividual",
      response: addressOfIndividual,
      ref: addressOfIndividualRef,
    },
    {
      type: "input",
      question: "Enter the full name of second individual (Agent)",
      action: setNameOfIndividual2,
      key: "nameOfIndividual2",
      response: nameOfIndividual2,
      ref: nameOfIndividual2Ref,
    },
    {
      type: "input",
      question: "Enter the full address of second individual (Agent)",
      action: setAddressOfIndividual2,
      key: "addressOfIndividual2",
      response: addressOfIndividual2,
      ref: addressOfIndividual2Ref,
    },
                  ...
                  <div>
                      ...
                      <font color="">
                        <font face="Garamond, serif">
                          <font
                            ...
                            ref={addressOfIndividualRef}
                          >
                            {insertInput(addressOfIndividual)}{" "}
                          </font>
                        </font>
                      </font>
                      <font face="Garamond, serif">
                      ...
                      <font color="">
                        <font face="Garamond, serif">
                          <font
                            ...
                            ref={addressOfIndividual2Ref}
                          >
                            {insertInput(addressOfIndividual2)}
                          </font>
                        </font>
                      </font>
                      <font face="Garamond, serif">
                    ...
                    >
                      <font face="Garamond, serif">
                        ...
                        >
                          {insertInput(nameOfIndividual, "bold")}
                        </font>
                      </font>
                    </p>
                    <p
                    ...
                    >
                      <font face="Garamond, serif">
                        <font
                          ...
                          ref={nameOfAgentRef}
                        >
                          {insertInput(nameOfIndividual2, "bold")}
                        </font>
                      </font>
                    </p>
                    <p
