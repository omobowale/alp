...
function Template5(props) {
  ...
  const questions = [
    ...
    },
    {
      type: "input",
      question:
        "Enter the name of witness",
      action: setInThePresenceOfName,
    },
    {
      type: "input",
      question:
        "Enter the address of witness",
      action: setInThePresenceOfAddress,
    },
    {
      type: "input",
      question:
        "Enter the occupation of witness",
      action: setInThePresenceOfName,
    },
            ...
            <div>
              ...
              >
                <font face="Garamond, serif">
                  <font size={3} style={{ fontSize: "12pt" }}>
                    Name:
                    {inThePresenceOfName !== "" &&
                    inThePresenceOfName !== placeholderMarker ? (
                      <u>{"    " + inThePresenceOfName + "    "}</u>
                    ) : (
                      <>{"    " + inThePresenceOfName + "    "}</>
                    )}
                  </font>
              ...
              >
                <font face="Garamond, serif">
                  <font size={3} style={{ fontSize: "12pt" }}>
                    Address:
                    {inThePresenceOfAddress !== "" &&
                    inThePresenceOfAddress !== placeholderMarker ? (
                      <u>{"    " + inThePresenceOfAddress + "    "}</u>
                    ) : (
                      <>{"    " + inThePresenceOfAddress + "    "}</>
                    )}
                  </font>
              ...
              >
                <font face="Garamond, serif">
                  <font size={3} style={{ fontSize: "12pt" }}>
                    Occupation:
                    {inThePresenceOfOccupation !== "" &&
                    inThePresenceOfOccupation !== placeholderMarker ? (
                      <u>{"    " + inThePresenceOfOccupation + "    "}</u>
                    ) : (
                      <>{"    " + inThePresenceOfOccupation + "    "}</>
                    )}
                  </font>
