...
function TemplateThree(props) {
  ...
  const [nameOfIndividual, setNameOfIndividual] = useState(placeholderMarker);
  const [addressOfIndividual, setAddressOfIndividual] =
            ...
            <div>
              ...
              >
                <font face="Garamond, serif">
                  <font face="Garamond, serif" size={3} style={{ fontSize: "12pt" }}>
                ...
                <font color="">
                  <font face="Garamond, serif">
                    <font size={3} style={{ fontSize: "12pt" }}>
                      {nameOfIndividual !== "" &&
                      nameOfIndividual !== placeholderMarker ? (
                        <u>{"    " + nameOfIndividual + "    "}</u>
                      ) : (
                        <>{"    " + nameOfIndividual + "    "}</>
                      )}
                    </font>
                ...
                <font color="">
                  <font face="Garamond, serif">
                    <font size={3} style={{ fontSize: "12pt" }}>
                      {addressOfIndividual !== "" &&
                      addressOfIndividual !== placeholderMarker ? (
                        <u>{"    " + addressOfIndividual + "    "}</u>
                      ) : (
                        <>{"    " + addressOfIndividual + "    "}</>
                      )}
                    </font>
              ...
              >
                ...
                <font color="">
                  <font face="Garamond, serif">
                    <font size={3} style={{ fontSize: "12pt" }}>
                      {nameOfCompany !== "" &&
                      nameOfCompany !== placeholderMarker ? (
                        <u>{"    " + nameOfCompany + "    "}</u>
                      ) : (
                        <>{"    " + nameOfCompany + "    "}</>
                      )}
                ...
                <font face="Garamond, serif">
                  <font size={3} style={{ fontSize: "12pt" }}>
                    ...
                    Republic of Nigeria with its office at
                  </font>
                </font>
                <font color="">
                  <font face="Garamond, serif">
                    <font size={3} style={{ fontSize: "12pt" }}>
                      {addressOfCompany !== "" &&
                      addressOfCompany !== placeholderMarker ? (
                        <u>{"    " + addressOfCompany + "    "}</u>
                      ) : (
                        <>{"    " + addressOfCompany + "    "}</>
                      )}
                    </font>
                ...
                <font face="Garamond, serif">
                  <font size={3} style={{ fontSize: "12pt" }}>
                    of the other part; which expression shall where the context
