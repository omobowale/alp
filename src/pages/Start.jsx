      ...
      <div className="w-3/4 md:mx-auto">
        <div className="flex justify-between items-center mb-3">
          <div className="flex gap-2 items-center">
            ...
            >
              {props.details.label?.toUpperCase()}
            </span>
          </div>
        ...
        <div className="">
          ...
          >
            ...
            props.details.description == null
              ? `Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut
